...
def get_score(lfd, lfb, heat_map, vc_part_p):
...
def get_scoreM(lfd, lfb, heat_map_M, vc_part_p):
    rst = []
    for hm, vcP in zip(heat_map_M, vc_part_p):
        rst.append(get_score(lfd, lfb, hm, vcP))
