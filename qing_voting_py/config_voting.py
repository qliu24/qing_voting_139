...
Dict['cache_path'] = '/export/home/qliu24/qing_voting_139/qing_voting_py/data/conv3_all_dumped_data'
...
VC['res_info'] = os.path.join(Data['root_dir2'], 'feat_pickle_alex', 'res_info_{0}_{1}.pickle')
...
Dictionary_car = '/export/home/qliu24/qing_voting_139/qing_voting_py/data/dictionary_PASCAL3D+_car_VGG16_{0}_K{1}_prune_{2}.pickle'.format(VC['layer'], VC['num_car'], featDim)
...
model_file_dic = dict()
for category in ['car']:
    model_file_dic[category] = os.path.join(Model_dir, 'VCpart_model_{0}_K4_term2_blur_coef.pickle'.format(category))
