...
model.fit_soft(feat_set, ass, centers, pi, 30, 50)

save_path = '/export/home/qliu24/qing_voting_139/qing_voting_py/data/dictionary_PASCAL3D+_car_VGG16_pool4_K200_vMFMM30_2.pickle'
...
for vc_i in range(cluster_num):
    patch_set = np.zeros(((100**2)*3, num)).astype('uint8')
