...
for ii,cc in enumerate(all_categories):
    ...
    fname = '/export/home/qliu24/qing_voting_139/qing_voting_py/data/pool3_all_dumped_data{}.pickle'.format(ii)
    print(fname)
    ...
    save_path = '/export/home/qliu24/qing_voting_139/qing_voting_py/data/dict/dictionary_PASCAL3D+_{}_VGG16_pool3_K{}_vMFMM30.pickle'.format(cc, cluster_num)
