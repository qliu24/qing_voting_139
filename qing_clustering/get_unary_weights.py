...
def get_unary_weights(category, magic_thrh = 0.85, stride=2, if_bg = True):
    ...
    save_path = '/export/home/qliu24/qing_voting_data/intermediate/unary_weights/'
